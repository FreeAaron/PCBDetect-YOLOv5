...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/PCBDetect.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/PCBDetect/weights/best.pt', help='model.pt path(s)')
